...
//import UIKit
//
//class ContactsTableViewController: UITableViewController, DatabaseListener, UISearchResultsUpdating {
//    // MARK: - Properties
//
...
////            let card = displayingCards.getDeletingCardAt(indexPath: indexPath, displayingCards: displayingCards)
////            databaseController?.removeCard(card: card)
////        }
////    }
////
